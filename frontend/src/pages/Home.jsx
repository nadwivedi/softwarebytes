      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            {servicesPreview.map((service, index) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <Link
                    to="/services"
                    className="inline-flex items-center gap-2 text-blue-600 font-medium group-hover:gap-3 transition-all duration-300"
                  >
                    Learn More
                    <span className="font-mono">&lt;/&gt;</span>
                  </Link>
          ...
          <div className="text-center mt-12">
            <Link
              to="/services"
              className="group inline-flex items-center gap-3 px-8 py-4 bg-gray-900 text-white font-semibold rounded-2xl hover:bg-gray-800 hover:shadow-xl transition-all duration-300"
            >
              View All Services
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {features.map((feature, index) => (
                  <div
                    key={index}
                    className="group flex items-start gap-4 p-5 bg-white rounded-2xl border border-gray-100 hover:shadow-lg hover:border-blue-100 transition-all duration-300"
                  >
